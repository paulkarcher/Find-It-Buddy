...
public class WordProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.words/words" will map to the
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case WORDS:
                // For the WORDS code, query the words table directly with the given
                // projection, selection, selection arguments, and sort order. The cursor
                // could contain multiple rows of the words table.
            ...
            case WORD_ID:
                ...
                // For an example URI such as "content://com.example.android.words/words/3",
                ...
                // This will perform a query on the words table where the _id equals 3 to return a
    ...
    private Uri insertWord(Uri uri, ContentValues values) {
        ...
        String name = values.getAsString(WordEntry.COLUMN_WORD_TEXT);
        if (name == null) {
        ...
        // Notify all listeners that the data has changed for the word content URI
    ...
    /**
     * Update words in the database with the given content values. Apply the changes to the rows
     * specified in the selection and selection arguments (which could be 0 or 1 or more words).
     * Return the number of rows that were successfully updated.
     */
    private int updateWord(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // If the {@link WordEntry#COLUMN_WORD_NAME} key is present,
        // check that the name value is not null.
        if (values.containsKey(WordEntry.COLUMN_WORD_TEXT)) {
            String name = values.getAsString(WordEntry.COLUMN_WORD_TEXT);
            if (name == null) {
                throw new IllegalArgumentException("Word requires a name");
            }
